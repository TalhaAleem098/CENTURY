      ...
      <div className="max-w-6xl mx-auto px-6 py-20 space-y-20">
        ...
        <section className="text-center space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
              Redefining fashion through premium quality, modern designs, and
              exceptional customer experience. Discover the story behind
              Pakistan&apos;s trusted fashion destination.
            </p>
          </div>
        </section>
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg leading-relaxed text-gray-700">
              Century was founded with a vision to revolutionize Pakistan&apos;s
              fashion landscape by offering premium quality clothing at
              accessible prices. What started as a passion project has grown
              into a trusted brand serving customers across the country.
            </p>
            <p className="text-lg leading-relaxed text-gray-700">
              Our commitment to excellence, combined with modern designs and
              customer-centric approach, has made us a preferred choice for
              fashion-conscious individuals who value both style and quality.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                To provide premium quality fashion that empowers individuals to
                express their unique style with confidence, while maintaining
            ...
            <div className="space-y-6">
              ...
              <div className="w-12 h-1 bg-black"></div>{" "}
              <p className="text-lg text-gray-700 leading-relaxed">
                To become Pakistan&apos;s leading fashion destination, known for
                exceptional quality, innovative designs, and customer experience
        ...
        <section className="space-y-12">
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Our values guide every decision we make and every interaction we
              have with our customers.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 border border-gray-200 rounded-2xl hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                meets our premium standards and exceeds customer expectations.
              </p>
            </div>
            <div className="text-center p-8 border border-gray-200 rounded-2xl hover:shadow-lg transition-shadow">
              <div className="w-16 h-16 bg-black rounded-full mx-auto mb-6 flex items-center justify-center">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                satisfaction and feedback drive our continuous improvement.
              </p>
            </div>
            <div className="text-center p-8 border border-gray-200 rounded-2xl hover:shadow-lg transition-shadow">
              <div className="w-16 h-16 bg-black rounded-full mx-auto mb-6 flex items-center justify-center">
              ...
              <p className="text-gray-700 leading-relaxed">
                We constantly evolve our designs, services, and customer
                experience to stay ahead of fashion trends and expectations.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-gray-50 rounded-3xl p-12 border border-gray-200">
          <div className="text-center space-y-12">
            <div>
              <h2 className="text-4xl font-bold mb-4">Century in Numbers</h2>
              <div className="w-16 h-1 bg-black mx-auto"></div>
            </div>
        ...
        <section className="space-y-8">
          <div className="text-center space-y-4">
            ...
            <div className="w-16 h-1 bg-black mx-auto"></div>{" "}
            <p className="text-lg text-gray-700 max-w-3xl mx-auto">
              Have questions or want to learn more about Century? We&apos;d love
              to hear from you.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 border border-gray-200 rounded-2xl">
              ...
              <div className="flex justify-center space-x-4">
                ...
                <a
                  href="https://www.tiktok.com/@century.pk"
                  className="text-gray-700 hover:text-black transition-colors"
                >
                  TikTok
                </a>
        ...
        {/* Call to Action */}
        <section className="text-center bg-black text-white py-16 rounded-3xl">
          <div className="space-y-8">
            <h2 className="text-4xl font-bold">Ready to Experience Century?</h2>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Explore our latest collections and discover fashion that defines
              your style.
            </p>
